...
import os
import re
from stock_idx import StockData
from translator_deepl import DeeplTranslator
from livecrawler import LiveCrawler
from gpt import summarize,keyword
...
class TelegramHandler:
    ...
    def start(update, context):        
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text="""주식챗봇 시작을 환영합니다.  [ /help ]를 클릭해주세요.""") 
    ...
    def favorites(update, context):
        ...
        if favorites_list:
            for favorite in favorites_list:
                ...
                index_button = InlineKeyboardButton(text=f'{favorite}차트', callback_data=f'index_{favorite}')
