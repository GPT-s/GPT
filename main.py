...
from src.crawler import Investing_Crawler, deepL_Translator
from src.gpt_keyword import get_analyze_keyword, analyze_keyword
from src.test_crawler import Investing_Crawler
...
for text in crawler.investing_latest():  # 모듈 통합 실행 코드
